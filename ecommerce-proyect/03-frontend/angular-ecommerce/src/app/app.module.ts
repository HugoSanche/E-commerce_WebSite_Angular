...
const routes:Routes=[
  ...
  //If authenticated give accesses to route else, send to login page
...
@NgModule({
  ...
  imports: [
    RouterModule.forRoot(routes),//this is const routes:Routes=[
    BrowserModule,
    HttpClientModule,
  ...
  providers: [ProductService,{provide:OKTA_CONFIG, useValue:{oktaAuth}},
    ...
    //multi:true Informs Angular that HTTP INTERCEPTOS is a token for injection an array of values
